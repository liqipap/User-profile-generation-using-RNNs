...
wordEmbeddings, indicator = load_my_vecs('data/zhwiki/zhwiki/zhwiki_2017_03.sg_50d.word2vec',
                              vocab)

inputs, targets = getPairs('Luhan_Star')

#example = variableFromSentence(vocab, inputs[3])
